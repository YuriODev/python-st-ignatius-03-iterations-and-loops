...
class TestExercise48(unittest.TestCase):
    def run_exercise(self, input_value):
        exercise_file_path = os.path.join(os.path.dirname(__file__), "exercise_48.py")
    ...
    def test_palindromes_100(self):
        ...
        self.assertEqual(output.strip(), "18")

    def test_palindromes_200(self):
        output = self.run_exercise("200\n")
        self.assertEqual(output.strip(), "27")

    def check_list_usage(self):
        with open("exercise_48.py", "r") as source_code:
